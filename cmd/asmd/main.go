...
import (
	...
	"github.com/mdhender/assemblage/internal/publish"
	"github.com/mdhender/assemblage/internal/render"
	"github.com/mdhender/assemblage/internal/server"
...
type flags struct {
	...
	// mistake: an operator running several asmd processes behind one proxy
...
// server builds the Server. A nil service is the "asmd routes" case: the table
