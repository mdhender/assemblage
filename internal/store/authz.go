...
// *ConstraintError answering to domain.ErrConflict, which is how "asmdb seed"
// is idempotent.
...
// end state is what was asked for, and "asmdb seed" runs more than once.
...
// SiteByDomain reads a site by the domain it serves, which is what "asmdb
