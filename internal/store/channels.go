...
// domain.ErrConflict, which is what makes "asmdb seed" idempotent without a
...
// OutputChannelByName reads one site's channel by name, which is how "asmdb
...
//
// The domain is what a deployment gets wrong: "asmdb seed" writes one, and
