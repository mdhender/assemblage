...
type NewElementType struct {
	...
	// one. "asmdb seed" writes an element type before there is anybody to
...
// "asmdb seed" idempotent without a read-then-write race.
...
// truth of the schema rather than of this query (0001_initial.sql).
