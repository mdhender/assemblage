...
// storySchema is the schema "asmdb seed" writes.
...
func TestNoStoreImport(t *testing.T) {
	...
	forbidden := map[string]string{
		"github.com/mdhender/assemblage/internal/store":   "a transport does not query (DESIGN.md 3, PLAN.md M13 acceptance 1)",
		"github.com/mdhender/assemblage/internal/migrate": "a transport does not migrate",
