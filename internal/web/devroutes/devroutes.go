...
// "go run ./cmd/asmd", and a guard that makes the normal workflow impossible
...
//     The handlers are never added to the mux, so "asmd routes" tells the
...
//
// It is an interface so that the route table "asmd routes" prints can be
