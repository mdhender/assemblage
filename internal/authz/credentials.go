...
//     cheaply -- "go run ./cmd/asmd" included -- and bcrypt records the cost
...
//
// One consequence worth knowing rather than discovering: a test that runs asmd
...
// cmd/asmd's tests barely moved in the measurement above.
...
// GeneratePassword returns a password for "asmdb bootstrap admin" to print
