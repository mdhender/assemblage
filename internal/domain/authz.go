...
// drops the disguise.
//
// Every field has a column in the initial schema. They are resolved together
// because a scope dimension that the resolver ignores is an authorization
// hole (internal/migrate/schema/0001_initial.sql).
type Scope struct {
...
type Grant struct {
	...
	// CreatedBy is the user who wrote the grant, or 0 for the system. "asmdb
